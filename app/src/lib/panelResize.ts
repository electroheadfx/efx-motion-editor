...
// --- 2-panel flex-based API (adaptive sidebar: seq + prop, no lay) ---
 ...
 * Converts pixel delta to flex-grow adjustments for seqFlex and propFlex.
 *
 * Positive deltaY increases seqFlex (panel above), decreases propFlex (panel below).
 * Panels below COLLAPSE_FLEX_THRESHOLD snap to 0 (collapsed).
 * Panels restored from 0 get at least MIN_RESTORED_FLEX.
 */
