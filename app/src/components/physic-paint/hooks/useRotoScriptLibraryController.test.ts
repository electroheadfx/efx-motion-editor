...
const launchContext = (): PhysicPaintLaunchContext => ({ operationId: 'launch', layerId: 'layer-1', layerName: 'Ink', startFrame: 4, width: 1600, height: 900, workflowMode: 'roto', project: { name: 'Project', saved: true, contextId: 'context-1' } });
