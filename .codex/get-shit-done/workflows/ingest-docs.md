...
```bash
INIT=$(node "/Users/lmarques/Dev/efx-motion-editor/.codex/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/lmarques/Dev/efx-motion-editor/.codex/get-shit-done/bin/gsd-tools.cjs" commit \
