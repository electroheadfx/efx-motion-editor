...
```
Apply each entry in `activeHooks` per @/Users/lmarques/Dev/efx-motion-editor/.codex/gsd-core/references/loop-hook-dispatch.md. Empty list → continue to `analyze_phase`.
</step>
...
```
Apply each entry in `activeHooks` per @/Users/lmarques/Dev/efx-motion-editor/.codex/gsd-core/references/loop-hook-dispatch.md. Empty list → continue to `confirm_creation`.
</step>
