...
```bash
INIT=$(node "/Users/lmarques/Dev/efx-motion-editor/.codex/gsd-core/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/lmarques/Dev/efx-motion-editor/.codex/gsd-core/bin/gsd-tools.cjs" commit \
