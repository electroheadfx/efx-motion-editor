...
```
Agent(
  prompt="Read /Users/lmarques/Dev/efx-motion-editor/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/lmarques/Dev/efx-motion-editor/.claude/gsd-core/templates/VALIDATION.md`
