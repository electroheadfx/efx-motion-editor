...
ones). Reference: @/Users/lmarques/Dev/efx-motion-editor/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /Users/lmarques/Dev/efx-motion-editor/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/Users/lmarques/Dev/efx-motion-editor/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "/Users/lmarques/Dev/efx-motion-editor/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/Users/lmarques/Dev/efx-motion-editor/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/Users/lmarques/Dev/efx-motion-editor/.claude/gsd-core/templates/spec.md.
