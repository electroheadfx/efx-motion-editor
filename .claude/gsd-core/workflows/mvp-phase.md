...
<required_reading>
@/Users/lmarques/Dev/efx-motion-editor/.claude/gsd-core/references/user-story-template.md
@/Users/lmarques/Dev/efx-motion-editor/.claude/gsd-core/references/spidr-splitting.md
@/Users/lmarques/Dev/efx-motion-editor/.claude/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/Users/lmarques/Dev/efx-motion-editor/.claude/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/Users/lmarques/Dev/efx-motion-editor/.claude/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@/Users/lmarques/Dev/efx-motion-editor/.claude/gsd-core/references/spidr-splitting.md`. Briefly:
