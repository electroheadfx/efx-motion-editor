...
<template>
@/Users/lmarques/Dev/efx-motion-editor/.claude/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/Users/lmarques/Dev/efx-motion-editor/.claude/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/Users/lmarques/Dev/efx-motion-editor/.claude/gsd-core/workflows/transition.md`.
