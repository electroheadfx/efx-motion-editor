...
**Read and run** the gate + edge probe in `/Users/lmarques/Dev/efx-motion-editor/.claude/gsd-core/references/specless-probe-fallback.md`
...
else-branch below, per §A/§B/§C of `/Users/lmarques/Dev/efx-motion-editor/.claude/gsd-core/references/specless-probe-fallback.md`
