...
**<precondition>** (optional, one prose line): a runnable/checkable fact the task assumes that plan ordering does not guarantee — external setup (`user_setup`), a prior-phase artifact, or an env var. The executor asserts it before running the task and halts on unmet. Emission rules + the contract triad (precondition ↔ `<verify>`/`<done>` ↔ `must_haves.truths`): @/Users/lmarques/Dev/efx-motion-editor/.claude/gsd-core/references/planner-preconditions.md.

**<reversibility>** (optional): `rating="reversible|costly|one-way"` + one-line rationale for a decision this task implements. `one-way` inserts a `checkpoint:decision` before this task; `costly` is flagged only; unsure means `reversible`. Rules: @/Users/lmarques/Dev/efx-motion-editor/.claude/gsd-core/references/planner-reversibility.md
...
Full rules: @/Users/lmarques/Dev/efx-motion-editor/.claude/gsd-core/references/context-budget.md (Phase Sizing). Read before sizing.
...
Three types: **checkpoint:human-verify (90%)**, **checkpoint:decision (9%)**, **checkpoint:human-action (1% - rare)**. Full "use for" criteria and XML templates for each: @/Users/lmarques/Dev/efx-motion-editor/.claude/gsd-core/references/checkpoints.md
...
Non-file coupling: @/Users/lmarques/Dev/efx-motion-editor/.claude/gsd-core/references/planner-coupling.md
</step>
...
See @/Users/lmarques/Dev/efx-motion-editor/.claude/gsd-core/references/planner-guidance.md for return formats; gap-closure returns are artifact-based (#3440).
