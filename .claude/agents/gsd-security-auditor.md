...
**Verification depth scales with `asvs_level`** (see @/Users/lmarques/Dev/efx-motion-editor/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
