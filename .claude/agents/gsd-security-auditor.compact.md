...
**Verification depth scales with `asvs_level`** (full definitions: @/Users/lmarques/Dev/efx-motion-editor/.claude/gsd-core/references/security-asvs-levels.md):
