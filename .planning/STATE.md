...
Last activity: 2026-09-21 - Completed quick task 260921-bjm: Studio gallery/background image imports lost across close/reopen — verdict (b) child-realm store write; the picker's Import now registers in the main-realm library via a child→main bridge pair; native UAT passed 2026-09-21
