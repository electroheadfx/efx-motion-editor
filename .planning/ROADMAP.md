...
- [ ] 36.2-08-PLAN.md — Add visible Roto interpolation controls and regeneration wiring.

**Gap Closure Wave 3** *(blocked on 36.2-08)*

- [ ] 36.2-09-PLAN.md — Add visible real-key Duplicate/Insert/Delete/Copy/Paste controls.

**Gap Closure Wave 4** *(blocked on 36.2-07 and 36.2-08)*

- [ ] 36.2-10-PLAN.md — Fix missing Roto paper/background preview, export, and playback behavior.
