...
- [ ] 36.14-11-PLAN.md — Audit Plan 20 semantic ownership, Plan 19 composition ownership, current callers, and stable-identity Clear through `useRotoFrameEditingController.ts`; run `pnpm --dir app typecheck` and `pnpm --dir app build` before the native gate.
