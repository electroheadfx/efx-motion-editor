...
| 43-06-T3 | 43-06 | 5 | HOLD-06 (D-01) | T-43-06-01 | Typed guarded bridge message; launch-or-focus; malformed payload rejected | unit | `pnpm --dir app exec vitest run physicsPaintBridgeTransport physicPaintBridge` | ❌ created in task | ⬜ pending |
| 43-08-T1 | 43-08 | 6 | HOLD-06 (D-03, D-17, D-23) | T-43-08-01 | Six hit regions incl. real-key-backed vs duplicated first-cycle branching; keyboard focus unit; no ghost key leakage | unit | `pnpm --dir app exec vitest run TimelineInteraction` | ❌ created in task | ⬜ pending |
