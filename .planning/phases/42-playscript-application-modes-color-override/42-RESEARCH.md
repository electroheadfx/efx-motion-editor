...
**How to avoid:** Update tooltip/summary copy as part of the panel plan; the two-line summary (D-07) must reflect the CURRENT session options, not the last generation.
