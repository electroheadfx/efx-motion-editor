...
| 42-03-T1 | 42-03 | 3 | PLAY-03, PLAY-04 | T-42-03-01 | dialog mirrors controller validation only — no dialog-side parsing; repeatError/setInfinity wiring | unit (component) | `pnpm --dir app exec vitest run src/components/physic-paint/view/PhysicsPaintPlayScriptDialog.test.ts src/components/physic-paint/roto/physicsPaintRotoPlayScriptController.test.ts` | ❌ dialog test created in 42-03-T2 / ✅ controller | ⬜ pending |
