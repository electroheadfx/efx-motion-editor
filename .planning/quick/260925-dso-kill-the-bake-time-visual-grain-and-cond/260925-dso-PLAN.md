...
<task type="auto">
  ...
  <verify>
  <automated>cd /Users/lmarques/Dev/efx-motion-editor/packages/efx-physic-paint && ../../app/node_modules/.bin/vitest run src/core/productionAaSettleMeasurement.test.ts src/core/physicsWidthScaling.test.ts src/core/physicsSettledFootprint.test.ts src/brush/paint.grainRemoval.test.ts src/engine/EfxPaintEngine.paperHeight.test.ts src/core/paperConditioning.test.ts; p=$?; npm run check; t=$?; ../../app/node_modules/.bin/vitest run; d="$(git -C /Users/lmarques/Dev/efx-motion-editor diff --name-only HEAD -- packages/efx-physic-paint/src/core/wet-layer.ts packages/efx-physic-paint/src/core/fluids.ts packages/efx-physic-paint/src/core/drying.ts packages/efx-physic-paint/src/render/compositor.ts packages/efx-physic-paint/src/core/paper.ts packages/efx-physic-paint/src/types.ts packages/efx-physic-paint/src/brush/stroke.ts packages/efx-physic-paint/src/render/canvas.ts package.json packages/efx-physic-paint/package.json app/package.json pnpm-lock.yaml app)"; test $p -eq 0 && test $t -eq 0 && test -z "$d"</automated>
  </verify>
