...
- [x] **DOC-03**: Pre-v1.0 Paint project data fails explicitly as unsupported without partial mutation or fallback rendering
...
- [x] **DOC-06**: Main-editor sequence timing and outer layer composition remain unchanged
