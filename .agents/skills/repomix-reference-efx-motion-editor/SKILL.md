---
name: repomix-reference-efx-motion-editor
description: Reference codebase for Efx Motion Editor. Use this skill when you need to understand the structure, implementation patterns, or code details of the Efx Motion Editor project.
---
